        ...
        <v-row no-gutters  v-if="this.pedido.length > 0">
            <v-col cols="12" v-for="(order,index) in this.pedido" :key="index" style="border: 1px solid rgba(0,0,0,0.12); margin-bottom: 24px; padding:0px">
                ...
                <v-row class="ma-1" >
                    ...
                    <v-col cols="12" sm="7" md="7" >
                        <h4 class="text-justify">Envio dentro del 1er y 2do anillo de Montero</h4>
                    </v-col>
                    <v-col cols="12" sm="3" md="3" style="display:flex; color: #D90000; " >
                        <h4 class="price">{{precioTransporte| moneda}} Bs.</h4>
                    </v-col>
                </v-row>
            </v-col>
        ...
        <v-dialog v-model="dialog" persistent max-width="400px">
            <v-card>
                ...
                <v-card-actions>
                    ...
                    <v-btn color="red" :disabled="loadingButton" text @click="motivoAnularPedido()" :loading="loadingButton" >confirmar</v-btn>
                </v-card-actions>
            </v-card>
        </v-dialog>
    </v-container>
